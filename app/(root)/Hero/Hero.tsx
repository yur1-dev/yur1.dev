    ...
    <div className="w-full px-4">
      <div className="max-w-[900px] h-[80vh] mx-auto flex flex-col justify-center relative">
        <div>
          ...
          {/* Portfolio Content */}
          <div
            className={`h-full w-full flex flex-col-reverse text-center lg:text-start lg:flex-row justify-between bg-black bg-opacity-80 rounded-xl border border-gray-700 relative z-10 p-6 transform transition-all duration-1000 ${
              isHeroVisible
